{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "gpuType": "T4",
      "authorship_tag": "ABX9TyPyKFPBCl/WeD63Be8xJZBe",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Abhi-3026/LLT-Transcribe/blob/main/transcribe%20code.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "pC9qUD0nKLEJ",
        "outputId": "392b1878-1609-4b64-aa8a-116f52fd5d85",
        "collapsed": true
      },
      "execution_count": 13,
      "outputs": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "u-6ct2CgLzsO",
        "outputId": "8657db46-b78a-4e0f-fe75-139b2340cd8d"
      },
      "execution_count": 14,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "collapsed": true,
        "id": "XJL5CkwnoONV",
        "outputId": "eb2759a7-a98f-4d6c-aefc-705b37a8801e"
      },
      "execution_count": 15,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "Requirement already satisfied: gruut in /usr/local/lib/python3.10/dist-packages (2.2.3)\n",
            "Requirement already satisfied: Babel<3.0.0,>=2.8.0 in /usr/local/lib/python3.10/dist-packages (from gruut) (2.16.0)\n",
            "Requirement already satisfied: dateparser~=1.1.0 in /usr/local/lib/python3.10/dist-packages (from gruut) (1.1.8)\n",
            ...
            "Requirement already satisfied: networkx<3.0.0,>=2.5.0 in /usr/local/lib/python3.10/dist-packages (from gruut) (2.8.8)\n",
            "Requirement already satisfied: num2words<1.0.0,>=0.5.10 in /usr/local/lib/python3.10/dist-packages (from gruut) (0.5.13)\n",
            "Requirement already satisfied: numpy<2.0.0,>=1.19.0 in /usr/local/lib/python3.10/dist-packages (from gruut) (1.22.0)\n",
            "Requirement already satisfied: python-crfsuite~=0.9.7 in /usr/local/lib/python3.10/dist-packages (from gruut) (0.9.11)\n",
            "Requirement already satisfied: python-dateutil in /usr/local/lib/python3.10/dist-packages (from dateparser~=1.1.0->gruut) (2.8.2)\n",
            "Requirement already satisfied: pytz in /usr/local/lib/python3.10/dist-packages (from dateparser~=1.1.0->gruut) (2024.2)\n",
            "Requirement already satisfied: regex!=2019.02.19,!=2021.8.27 in /usr/local/lib/python3.10/dist-packages (from dateparser~=1.1.0->gruut) (2024.9.11)\n",
            "Requirement already satisfied: tzlocal in /usr/local/lib/python3.10/dist-packages (from dateparser~=1.1.0->gruut) (5.2)\n",
            "Requirement already satisfied: six in /usr/local/lib/python3.10/dist-packages (from jsonlines~=1.2.0->gruut) (1.16.0)\n",
            "Requirement already satisfied: docopt>=0.6.2 in /usr/local/lib/python3.10/dist-packages (from num2words<1.0.0,>=0.5.10->gruut) (0.6.2)\n",
            "Collecting pyaudio\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "E-dW5P8NVS6N",
        "outputId": "476dbdb5-b303-4755-81d2-8d8698d2517a",
        "collapsed": true
      },
      "execution_count": 10,
      "outputs": [
        ...
        },
        {
          ...
          "text": [
            ...
            "['All of us desire to experience God’s work in our lives.', 'We desire God’s power to save, heal, deliver and work miracles both personally and for others.', 'Very often, we expect a spectacular display of God’s power, something that will “wow” us.', 'While it is true that God, by the power of His Holy Spirit, will demonstrate His work in spectacular ways with signs and wonders, we must not forget that God also works by His Word.', 'The Spirit of God releases His power through the Word of', 'God.', 'While the process of reading, meditating and receiving', 'God’s Word into our lives may not appear spectacular, it is no less supernatural because it is still God who is at work.', 'Many believers miss out on the supernatural work of God that God desires to release through His Word in their everyday lives because they keep seeking the spectacular.', 'Another common problem is that many believers look to the anointed man or woman of God to administer the power of God for them.', 'While God has anointed ministers who serve people by the power of His Spirit, eventually, every believer should come to the place where they learn to receive from God through His Word and by His Spirit.', 'Jesus invited all of us to go directly to Him, to eat of Him and drink from Him so that each one of us can become dispensers of His grace to others and bring them to Jesus so that they too can eat and drink from', 'Him.', 'We should not become dependent on intermediaries.', 'We know that God works through His Word.', 'This is how', 'He created everything—by His power released through His', 'Word.', 'God’s Word is a carrier of the life and power of God', 'Introduction', 'that can affect every aspect of our lives.', 'God has given us His', 'Word and seeks to work in us through the power of His Word.', 'He has also revealed to us how to receive His Word so that the life and power contained in His Word is released into us causing His supernatural work to take place in us.', 'Meditation on God’s Word is the process through which the Word becomes implanted in our hearts.', 'Meditating on God’s Word involves contemplation, visualization and confession.', 'You will learn how to practice meditating on God’s', 'Word so that the Miracle Seed of God’s Word can produce in your life.', 'This book unveils simple truths that will help us receive and experience the supernatural power of God released in us through His Word, the Miracle Seed', 'There is one important element in our Christian walk, one so essential that it determines the quality of our entire Christian experience.', 'This is the Word of God.', 'The level of maturity we grow into and the depths we reach in God are determined by the place we give to His Word in our lives.', 'Whether we walk in victory or not and the measure of blessings we experience is greatly influenced by the measure of God’s Word that we are able to receive and consistently practice in our daily living.', 'However, in a world that is given to “phenomena” where the spectacular is sought after, not many are ready to pay attention to the contents of an “Ancient Book.”', 'Why would someone spend time in deciphering mere words from a religious book that some claim to be socially, culturally and morally irrelevant?', 'And sadly, even among believers, apart from fulfilling an obligation of having a “quiet time,” there are not many who have received an understanding of the depth of impact and influence the written Scriptures can have on one’s life.', 'It is true that, at first, the Scriptures may seem lifeless, perhaps, even boring for the casual reader.', 'But to those who have received an understanding of its inherent power and the place that God Himself has assigned His Word to have in the lives of His people, the Word is alive!', 'To them, the Word is the source of strength, comfort, hope, faith, instruction and wisdom.', 'They have rested their entire present and future on what the', 'God’s Word: The Foundation of Our Faith', 'Scriptures say.', 'Amidst the storms of life, they know that the', 'Word will sustain them and hold them up.', 'Amid sickness, they know that the Word will bring healing and deliverance.', 'During challenges and pressures, they stand confident on what the', 'Word promises.', 'They can laugh at impossibilities because of the possibilities they see in the Word.', 'Even when they cannot see, touch, hear, smell or taste, they still know because the', 'Word has produced in them a confident assurance and a strong, unshakable conviction.', 'Our hearts’ desire is that each one who reads this book will be brought to this confident assurance in their walk with the Lord.', 'If you have already attained some degree of understanding in the Word, we desire that you will be strengthened and encouraged even more.', 'The Eternal Word, the Incarnate Word, the Written', 'Word', 'Luke 24:27', 'And beginning at Moses and all the Prophets, He expounded to them in all the Scriptures the things concerning Himself.', 'Jesus, the Son of God, the Eternal Word (John 1:1-4), who became the Incarnate Word (John 1:14) lived by, preached and taught from the written Word, the Scriptures.', 'From an early age, Jesus engaged in the study and learning of the Scriptures (Luke 2:46).', 'He resisted temptations using the written Word (Matthew 4:1-10).', 'The Incarnate Word was anointed by the', 'Spirit and walked in such a way to fulfill the Scripture (Luke', '4:21; Mark 14:49; Luke 24:44).', 'Is not this such an awesome thought—the Eternal Word, God who became flesh would handle the written Word with such honor.', 'How much more should we?', 'God’s Word The Miracle Seed', 'Through the foolishness of preaching', '1 Corinthians 1:21', 'For since, in the wisdom of God, the world through wisdom did not know God, it pleased God through the foolishness of the message preached to save those who believe.', 'God, in His wisdom, has assigned that the eternal destiny of a man’s life is determined through the simple preaching of the Gospel message.', 'Consider this!', 'God did not choose an army of angels to take the “Good news of Christ, which is the power of God unto salvation” to all men.', 'Instead, through the almost “foolish” exercise of preaching, which He ordained to be done through mortal, fallible vessels, He has chosen to win the lost.', 'Therefore, preaching or communicating the Gospel is so important.', 'As the apostle Paul explained, some may consider both the message and the preaching of it as foolishness.', 'But to those who are called, the message and its preaching reveals', 'Christ, who is the power and wisdom of God (1 Corinthians', '1:24).', 'In a similar manner, God has ordained that the written', 'Scripture be a tool by which the power and wisdom of God is brought into our lives.', 'It seems almost a mystery that through the words inscribed on the pages of the book we call the Bible, there is divine power and wisdom transmitted into our lives.', 'How could ordinary words, words we use in our everyday life, suddenly take on divine value just because they are printed in the Bible?', 'While the words in themselves are ordinary, the truths they present are divine.', 'While it was man who assembled the words, it was God who inspired the truth that is presented.', 'And it is through us understanding and accepting the truths that are conveyed through the words of the Scripture that we enter and experience the wisdom and power of God.', 'All Scripture is “God-Breathed”', '2 Timothy 3:15,16', '15 and that from childhood you have known the Holy Scriptures, which are able to make you wise for salvation through faith which is in Christ', 'Jesus.', '16 All Scripture is given by inspiration of God, and is profitable for doctrine, for reproof, for correction, for instruction in righteousness,', 'When the apostle Paul referred to the “Holy Scriptures,” he was talking about the written Scriptures.', 'He ascribes divine authorship to the written Scripture when He says, “All Scripture is given by inspiration of God.”', 'Even though man penned the words, God was the source and inspiration of the message.', 'The apostle Peter brings this out in a slightly different manner when he states, “knowing this first, that no prophecy of Scripture is of any private interpretation, for prophecy never came by the will of man, but holy men of God spoke as they were moved by the Holy Spirit.” (2 Peter 1:20,21).', 'All Scripture is prophetic in the sense that they were birthed through the inspiration of the', 'Spirit of God.', 'The written Word is divinely inspired.', 'Believing this fact in the very core of your being can totally transform your view of the Scriptures.', 'If you really believe that all Scripture is inspired by God, then you will give high priority to the Word of God in your life.', 'You will open your Bible knowing that the God of this universe is communicating His thoughts to you.', 'Out of His infinite wisdom, He has chosen to distil what', 'He considered essential and sufficient for our lives on earth and has placed them in the pages of the Book.', 'The Scriptures provide teaching (doctrine), conviction, correction (reproof)', 'The Scriptures—our window into God', 'Psalm 119:18', 'Open my eyes, that I may see Wondrous things from Your law.', 'The Scriptures provide us with insight into the living God.', 'They reveal the nature, the character, the attributes and the heart of God.', 'In the pages of the Scriptures, we find insight into who God is, what He does, His feelings and His desires.', 'Consequently, it is through the Scriptures that we get to know', 'God and thereby, build a personal relationship with Him.', 'Relationship is based on knowledge.', 'Where there is no personal knowledge, there can be no relationship.', 'Further, the depth of knowledge or intimacy attained determines the depth of the relationship.', 'Therefore, to have a deep and close relationship with the living God, one would have to know Him intimately as He is revealed in the Scriptures.', 'It is so exciting to open the pages of the Bible because they are our window into God.', 'When our eyes are opened to see “behind” the lines that we read, we gain understand .']\n",
            "vɛɹi ɔftən, wi ɪkspɛkt ə spɛktækjəlɚ dɪspleɪ əv ɡɑdz paʊɚ, sʌmθɪŋ ðæt wɪl “waʊ” ʌs.\n",
            " [!] Character '“' not found in the vocabulary. Discarding it.\n",
            "vɛɹi ɔftən, wi ɪkspɛkt ə spɛktækjəlɚ dɪspleɪ əv ɡɑdz paʊɚ, sʌmθɪŋ ðæt wɪl “waʊ” ʌs.\n",
            " [!] Character '”' not found in the vocabulary. Discarding it.\n",
            "ɡɑdz wɚd ɪntu aʊɚ lɪvz meɪ nɑt əpɪɹ spɛktækjəlɚ, ɪt ɪz noʊ lɛs supɚnæt͡ʃɚəl bɪkʌz ɪt ɪz stɪl ɡɑd hu ɪz æt wɚk.\n",
            " [!] Character '͡' not found in the vocabulary. Discarding it.\n",
            "hi kɹieɪtɪd ɛvɹiθɪŋ—baɪ hɪz paʊɚ ɹilist θɹu hɪz\n",
            " [!] Character '—' not found in the vocabulary. Discarding it.\n",
            " > Processing time: 7.275718688964844\n",
            " > Real-time factor: 0.010557734963114948\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "O_M0jrcOKYK6",
        "outputId": "7b701714-e026-4b76-cb0d-976a9403a7ff"
      },
      "execution_count": 6,
      "outputs": [
        {
